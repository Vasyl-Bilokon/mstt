...
public class SpeleologistAgent extends Agent {
                ...
                case 3 -> {
                    ...
                    if (reply != null) {
                        if (reply.getPerformative() == ACLMessage.PROPOSE) {
                            ...
                            switch (action) {
                                case Commands.TURN_LEFT -> content = WumpusWorldAgent.Constants.SPELEOLOGIST_TURN_LEFT;
                                case Commands.TURN_RIGHT -> content = WumpusWorldAgent.Constants.SPELEOLOGIST_TURN_RIGHT;
                                case Commands.MOVE_FORWARD -> content = WumpusWorldAgent.Constants.SPELEOLOGIST_MOVE_FORWARD;
                                case Commands.GRAB -> content = WumpusWorldAgent.Constants.SPELEOLOGIST_GRAB;
                                case Commands.SHOOT -> content = WumpusWorldAgent.Constants.SPELEOLOGIST_SHOOT;
                                case Commands.CLIMB -> content = WumpusWorldAgent.Constants.SPELEOLOGIST_CLIMB;
                                default -> System.out.println("SpeleologistAgent: There is no right action!");
                            }
    ...
    final static class Commands {
        ...
        static final Map<Integer, String> WORDS = new LinkedHashMap<>() {{
            put(1, "left");
            put(2, "right");
            put(3, "forward");
            put(4, "grab");
